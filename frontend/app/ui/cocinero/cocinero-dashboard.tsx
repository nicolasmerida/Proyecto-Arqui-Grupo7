          ...
          <div className="flex flex-row lg:flex-col py-1 w-full gap-4 pt-10 lg:pt-1">
            {pendientes.map((comanda) => (
              <div key={comanda.numeroComanda} className={`flex flex-col sm:flex-row lg:flex-col border-y-4 ${colorByState[comanda.estadoComanda]} shadow-sm`}>
                ...
                <button
                  className="rounded-b-md sm:rounded-b-none sm:rounded-r-md lg:rounded-b-md py-2 flex items-center justify-center gap-2 bg-orange-100 hover:bg-orange-200 transition-colors text-orange-800 font-bold disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="flex flex-row lg:flex-col py-1 w-full gap-4 pt-10 lg:pt-1">
            {enPreparacion.map((comanda) => (
              <div key={comanda.numeroComanda} className={`flex flex-col sm:flex-row lg:flex-col border-y-4 ${colorByState[comanda.estadoComanda]} shadow-sm`}>
                <CommandCard command={comanda} state={comanda.estadoComanda} lastUpdate={lastItemUpdate} />
                <button
                  className="rounded-b-md sm:rounded-b-none sm:rounded-r-md lg:rounded-b-md py-2 flex items-center justify-center gap-2 bg-green-100 hover:bg-green-200 transition-colors text-green-800 font-bold disabled:opacity-50 disabled:cursor-not-allowed"
